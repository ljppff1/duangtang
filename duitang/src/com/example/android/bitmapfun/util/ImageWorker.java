...
import com.ljppff.duitang.BuildConfig;
...
public abstract class ImageWorker {
	 ...
	 * {@link com.example.android.bitmapfun.util.ImageWorker#processBitmap(Object)} to define the processing
	 * logic). A memory and disk cache will be used if an {@link com.example.android.bitmapfun.util.ImageCache} has
	 * been set using {@link com.example.android.bitmapfun.util.ImageWorker#setImageCache(com.example.android.bitmapfun.util.ImageCache)}. If the
	 ...
	 * image is found in the memory cache, it is set immediately, otherwise an
	 * {@link android.os.AsyncTask} will be created to asynchronously load the bitmap.
	 * {@link com.example.android.bitmapfun.util.ImageWorker#setAdapter(com.example.android.bitmapfun.util.ImageWorker.ImageWorkerAdapter)} must be called before
	 * using this method.
	 * 
	 * @param data
	 *            The URL of the image to download.
	...
	/**
	 * Set the {@link com.example.android.bitmapfun.util.ImageCache} object to use with this ImageWorker.
	 * 
	 * @param cacheCallback
	 */
	 ...
	 *            {@link com.example.android.bitmapfun.util.ImageWorker#loadImage(Object, android.widget.ImageView)}
