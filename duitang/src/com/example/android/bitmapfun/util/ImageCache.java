...
public class ImageCache {
    ...
    /**
     * Find and return an existing ImageCache stored in a {@link com.example.android.bitmapfun.util.RetainFragment}, if not found a new
     * one is created with defaults and saved to a {@link com.example.android.bitmapfun.util.RetainFragment}.
     *
    ...
    /**
     * Find and return an existing ImageCache stored in a {@link com.example.android.bitmapfun.util.RetainFragment}, if not found a new
     * one is created using the supplied params and saved to a {@link com.example.android.bitmapfun.util.RetainFragment}.
     *
     * @param activity The calling {@link android.support.v4.app.FragmentActivity}
