...
public class DiskLruCache {
	 ...
	 * {@link com.example.android.bitmapfun.util.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra
	 ...
	 * be called directly, call {@link com.example.android.bitmapfun.util.DiskLruCache#clearCache(android.content.Context, String)}
	 * or {@link com.example.android.bitmapfun.util.DiskLruCache#clearCache()} instead.
	 * 
	 * @param cacheDir
	 ...
	 * {@link com.example.android.bitmapfun.util.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set
